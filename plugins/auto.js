...
r_text[1] = "Akshay tholpikkaan ningalkavilla. Jeevitathil Akshay tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "Akshay says i love you 😘";
r_text[3] = "Akshaysernte yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "Akshayser - Akshu - crazyhacker \ningane ethra ethra paerugal aan alle enikk..😂🤣";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per akshayser ,ninte per donkey, backi ellarum monkey😼😼";
r_text[10] = "nee vilicha enikk villi kelkathe irrikkaan pattuo";
r_text[11] = "do you know who is my creator..? its none other than Akshay";
...
r_text[13] = ".song adich thangalude fav song name para Akshayser ath download aakki theraam";
...
r_text[18] = "enikk njan und Akshayser uyir";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe akshayser pazhaya Akshayser thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik Akshayser";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee K.K. Akshayser";
